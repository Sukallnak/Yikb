...
export const STAND_CODEX: Record<Exclude<StandId, "none">, StandCodexEntry> = {
  ...
  whitesnake: {
    id: "whitesnake",
    model: {
      description: "Tall pale humanoid in dark executioner's leather, crown-like mask, GACT stripes across its skin, melting irises.",
      silhouette: ["crown-spike mask", "striped pale torso", "leather straps"],
      auraColor: "#e8e8ee",
    },
    moves: {
      m1: moveOf("whitesnake", "m1", "Light jab — 2.6 dmg."),
      a1: moveOf("whitesnake", "a1", "Improvisation — Glock 17, three line-traced bullets, last has knockback."),
      a2: moveOf("whitesnake", "a2", "Your DISC is mine — short-range grab, steals a DISC, slows 6.3s + DoT."),
      a3: moveOf("whitesnake", "a3", "Acidic Stab — short chop, applies 1 dps for 7s."),
      a4: moveOf("whitesnake", "a4", "Hypnotic Spit — no damage, stuns enemy for 12s."),
    },
  },
  c_moon: {
    id: "c_moon",
    model: {
      description: "Skeletal pale humanoid, LED orbital eyes, GACT-striped hips and chest, four wide flaps in place of Whitesnake's crown.",
      silhouette: ["four-flap crown", "thin waist", "arrow-shaped vestiges on limbs"],
      auraColor: "#cfd2d8",
    },
    moves: {
      m1: moveOf("c_moon", "m1", "Heavy punch — 3.5 dmg, damages props."),
      a1: moveOf("c_moon", "a1", "Punishment — gravity-inversion bubble, hostiles float and drop for 18 dmg after 8s."),
      a2: moveOf("c_moon", "a2", "—"),
      a3: moveOf("c_moon", "a3", "—"),
      a4: moveOf("c_moon", "a4", "—"),
    },
