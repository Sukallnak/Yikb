...
export type StandRarity = "common" | "uncommon" | "rare" | "epic" | "pebble" | "legendary" | "wip";
...
export type AbilityKind =
  ...
  | "ger_truth_punch"
  | "ger_triple_loop"
  // Whitesnake (W.I.P. — granted by green W.I.P. Arrow only)
  | "ws_improvisation"
  | "ws_disc_steal"
  | "ws_acidic_stab"
  | "ws_hypnotic_spit"
  | "prime_heal"
  // C-Moon (granted by Green Baby on a Whitesnake user)
  | "cmoon_punishment"
  | "cmoon_shotgun";
...
export const STANDS: Record<StandId, Stand> = {
  ...
  rhcp: {
    ...
    abilities: {
      ...
      a3: { name: "Lightning Pillar", kind: "lightning_pillar", damage: 14, range: 260, radius: 28, cooldown: 6, color: "#fff36b" },
  ...
  echoes: {
    ...
    abilities: {
      ...
      a1: { name: "ゴゴゴ Bleed", kind: "bleed_text", damage: 2, range: 180, radius: 8, cooldown: 3.2, speed: 260, duration: 6, color: "#ff4d4d" },
  ...
  whitesnake: {
    id: "whitesnake",
    name: "Whitesnake (W.I.P.)",
    color: "#e8e8ee",
    rarity: "wip",
    rarityWeight: 0, // green-arrow-exclusive, W.I.P. tier (will rotate out)
    abilities: {
      m1: { name: "Punch", kind: "melee", damage: 2.6, range: 22, radius: 14, cooldown: 0.32, color: "#e8e8ee" },
      a1: { name: "Improvisation", kind: "ws_improvisation", damage: 5, range: 280, radius: 4, cooldown: 12.7, speed: 520, knockback: 120, color: "#cfd2d8" },
      a2: { name: "Your DISC is mine", kind: "ws_disc_steal", damage: 7.9, range: 24, radius: 16, cooldown: 4.9, stunSeconds: 6.3, duration: 10, color: "#a8e8ff" },
      a3: { name: "Acidic Stab", kind: "ws_acidic_stab", damage: 4.7, range: 26, radius: 14, cooldown: 16, duration: 7, color: "#7fd16a" },
      a4: { name: "Hypnotic Spit", kind: "ws_hypnotic_spit", damage: 0, range: 220, radius: 8, cooldown: 13, speed: 280, stunSeconds: 12, color: "#ffffff" },
    },
  },
  c_moon: {
    id: "c_moon",
    ...
    color: "#cfd2d8",
    rarity: "legendary",
    rarityWeight: 0, // green-baby-exclusive evolution
    abilities: {
      m1: { name: "Punch", kind: "melee", damage: 3.5, range: 22, radius: 16, cooldown: 0.3, color: "#cfd2d8" },
      a1: { name: "Punishment", kind: "cmoon_punishment", damage: 18, range: 0, radius: 60, cooldown: 21, duration: 6, color: "#a06bff" },
      a2: { name: "Shotgun Blast", kind: "cmoon_shotgun", damage: 2.5, range: 240, radius: 5, cooldown: 10, speed: 360, color: "#b89aff" },
      a3: { name: "-", kind: "melee", damage: 0, range: 0, cooldown: 999, color: "#888" },
      a4: { name: "-", kind: "melee", damage: 0, range: 0, cooldown: 999, color: "#888" },
    },
  },
...
export function effectiveTierPct(rareLuck = 1): Record<StandRarity, number> {
  ...
  return { common, uncommon, rare, epic, pebble: 0, legendary: 0, wip: 0 };
}
